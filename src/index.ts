...
(function() {
  ...
  function getLocation(request, response) {
    ...
    return rp(options).then((res: AlexaLocation) => {
  ...
  function requestLocationPermission(request, response) {
    response.say(
      'The Adopt a Pet skill requires your location so I can find animals and shelters near you.  Please check your Alexa app to enable your location.'
    );
    response.card({
